...
>>>>>>> 14adafb325f3936c09cec064ce98d9dad260f90a
...
class App(QMainWindow):
    def __init__(self):
        ...
        self.video_source = 'exemplo.mp4'  # Atualize para o caminho correto do seu vídeo de teste
        ...
        self.status_label = QLabel(f"📡 Fonte de Vídeo: {self.video_source}\n🛠️ Modelo: {self.get_current_model_name()}", self)
        ...
        # Seleção de Modelo (opcional, caso queira duplicar na barra lateral)
        # Já está na seção de vídeo, então podemos omitir ou manter
